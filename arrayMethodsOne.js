...
// CODE HERE
const postTax = prices.map((element) => {
  return element * 1.07
})
...
// const myStrongest = monstersInYourPocket.filter((monstersInYourPocket[monster.CP]) => monstersInYourPocket[monster.CP] > 200)
...
// CODE HERE
const totalCalculator = orders.map((order) => {
